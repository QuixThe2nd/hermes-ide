...
import { $botSections, $draggingBot, adoptBotSectionsFromMeta, type SectionDialogState } from './user-sections'
...
export function BotsPane() {
  ...
  // draws the same folders instead of a flat list (#114355).
  useEffect(() => {
