...
def _run_attached_cell(kernel: RemoteKernel, key: Tuple, code: str, *, env, task_env_id: str,
    ...
    # of CellAuthority: authority lives exactly as long as the cell's poll loop. Fresh
    # read-dedup scope so nested read_file results from this cell cannot satisfy a later
    # execute_code call.
