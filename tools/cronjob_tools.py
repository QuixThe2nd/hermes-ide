...
from tools.cronjob_job_args import (
    ...
    _validate_cron_enabled_toolsets,
...
def _action_create(a: Dict[str, Any]) -> str:
    ...
    error = (
        ...
        # A typo'd toolset name must fail the CREATE, not the first fire.
        or (a["enabled_toolsets"] and _validate_cron_enabled_toolsets(a["enabled_toolsets"]))
...
def _update_run_fields(job: Dict[str, Any], a: Dict[str, Any], updates: Dict[str, Any]) -> Optional[str]:
    ...
    if a["enabled_toolsets"] is not None:
        toolsets_error = _validate_cron_enabled_toolsets(a["enabled_toolsets"])
        if toolsets_error:
            return toolsets_error
