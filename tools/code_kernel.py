...
class CellAuthority:
    ...
    def __init__(self, task_id: str):
        ...
        # Isolate read-file dedup per cell. Session kernels reuse one
        # interpreter, but nested read_file results still exist only inside
        # this cell — a later execute_code call with the same task_id must
        # receive the content again (fork contract from 172de904f3).
