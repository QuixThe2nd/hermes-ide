"""Best-effort user-visible notifications for update outcomes."""
...
def notifications_log_path() -> Path:
    return get_hermes_home() / "auto-update" / "notifications.log"
...
def emit_notification(
    ...
    *,
    ...
    try:
        ...
        logger.debug("auto-update notification failed (non-fatal): %s", exc)
