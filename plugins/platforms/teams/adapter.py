...
def _env_enablement() -> dict | None:
    ...
    Every identity/endpoint is per-profile (the app the secret belongs to, its regional service URL), so a secondary is never seeded with the default profile's Teams app."""
