...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def _ensure_writer(self) -> None:
        ...
        # via spawn_context_thread. (The shared ``hindsight-loop`` thread
        # needs no wrap: coroutines scheduled via run_coroutine_threadsafe
        # inherit the submitter's context per call, so one loop can serve
        # every profile.)
