...
# ---------------------------------------------------------------------------
# Fork-only ``thread:`` deliver-token helpers (hermes-ide). Upstream's Sep 2026
# decomposition of this module did not carry them; restored here so
# ``from cron.scheduler import _parse_thread_deliver_token`` (and friends, see
# tests/cron/test_cron_deliver_thread_autocreate.py) keeps resolving. The
# resolution/delivery integration point lives in cron/scheduler_delivery.py
# (_resolve_single_delivery_target / _deliver_result) — see COMPAT notes.
# ---------------------------------------------------------------------------
...
from cron.scheduler_delivery import (  # noqa: E402
    _deliver_result, _delivery_lane_value, _normalize_deliver_value, _record_delivery_verification,
...
from cron.scheduler_preflight import (  # noqa: E402
    ...
    _empty_requested_mcp_toolsets, _is_transient_provider_resolve_error, _preflight_check_delivery, _preflight_job_config,
)
