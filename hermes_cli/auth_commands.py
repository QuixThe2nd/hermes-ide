...
def _add_api_key_credential(args, provider: str, pool) -> PooledCredential:
    ...
    entry = PooledCredential(
        ...
        priority=0, source=SOURCE_MANUAL, access_token=token,
        # api_key flows into base-URL resolution: z.ai probes for the endpoint the key
        # actually works at and ``sk-kimi-`` keys route to the Kimi Code endpoint.
