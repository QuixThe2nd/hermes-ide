...
#   - insights: usage analytics; reached via /hermes insights on Slack.
#     Upstream demoted it at the 50-cap so a native slot would not clamp
#     higher-value recurring commands.
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "egress", "init", "version", "diff", "update", "heartbeat", "refine", "review", "pause", "whoami", "platform", "setnotify", "clearnotify", "sethomeserver", "insights"})
