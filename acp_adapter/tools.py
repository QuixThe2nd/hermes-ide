...
TOOL_KIND_MAP: Dict[str, ToolKind] = {
    ...
    for kind, names in {
        ...
        "execute": ("terminal", "process", "execute_code", "browser_click", "browser_type", "browser_scroll",
                    "browser_press", "browser_back", "delegate_agent", "delegate_task", "image_generate", "text_to_speech"),
...
_TITLE_BUILDERS: Dict[str, Callable[[Args], str]] = {
    ...
    "delegate_agent": _title_delegate,
    # Hidden legacy alias renders through the same builder.
...
_COMPLETION_FORMATTERS: Dict[str, _Formatter] = {
    ...
    "delegate_agent": _format_delegate_result,
...
_START_CONTENT_BUILDERS: Dict[str, Optional[Callable[[Args], Any]]] = {
    ...
    "delegate_agent": _start_delegate,
    # Hidden legacy alias renders through the same builder.
