...
- **Plugins**
  ...
  - pr_intent_watch — watches QuixThe2nd/hermes-ide for new PRs and comments an intent review (objective / worth considering / is this a real bug), not a code review
