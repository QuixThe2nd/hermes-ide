    ...
    if agent.valid_tool_names:
        parts += [
            text for flag, text in (
                ...
                # Universal tool-call narration — explain each tool call before
                # making it and briefly note significant results; on chat platforms
                # a silent multi-call chain looks like a frozen client (fork).
                ("_tool_call_narration_guidance", TOOL_CALL_NARRATION_GUIDANCE),
