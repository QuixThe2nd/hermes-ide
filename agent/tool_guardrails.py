...
MUTATING_TOOL_NAMES = frozenset({
    ...
    "send_message", "cronjob", "cronjob_manage", "delegate_agent", "delegate_task", "process_manage",
})
...
_LOOP_CAPS: dict[str, tuple[str, str, str]] = {
    ...
    # delegate_agent is canonical; delegate_task is the hidden legacy alias (same cap).
    "delegate_agent": ("max_subagents", "_turn_subagent_count", "loop_subagent_cap"),
