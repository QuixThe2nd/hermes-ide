...
# pre_turn_end (fork) shares pre_verify's directive contract — "continue"/"block" with a
# follow-up message — so it reuses the same parser.
_RESPONSE_PARSERS: Dict[str, Callable[[Dict[str, Any]], Optional[Dict[str, Any]]]] = {
    "pre_tool_call": _parse_pre_tool_call, "pre_verify": _parse_pre_verify, "pre_turn_end": _parse_pre_verify,
}
