...
class GatewayConfig:
    ...
    # Session reset policies (fork feature; upstream moved to a session-lifecycle decision table).
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        # Session reset policies (fork feature): default + type/platform overrides.
